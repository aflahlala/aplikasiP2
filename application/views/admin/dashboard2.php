									...
									<div class="bs-stepper-content">
										...
										<div id="information-part4" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
											...
											<div class="form-group">
												...
												<select id="inputSeksi" class="form-control custom-select" onchange="myFunction(this.value);">
											...
											<div class="form-group">
												...
												<select id="inputSeksi" class="form-control custom-select" onchange="myFunctionPel1(this.value);">
													<option selected disabled>Pilih Nama</option>
													<?php foreach ($anggota as $key => $data): ?>
														<option value=<?php echo $data->NIP ?>><?php echo $data->username ?></option>
													<?php endforeach ?>
											...
											<div class="form-group">
												...
												<select id="inputSeksi" class="form-control custom-select" onchange="myFunctionPel2(this.value);">
													<option selected disabled>Pilih Nama</option>
													<?php foreach ($anggota as $key => $data): ?>
														<option value=<?php echo $data->NIP ?>><?php echo $data->username ?></option>
													<?php endforeach ?>
