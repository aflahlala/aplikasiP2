            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select id="inputKabid" class="form-control custom-select" onchange="myFunction(this.value);">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select id="inputSeksi" class="form-control custom-select" onchange="myFunctionSek(this.value);">
                    <option selected disabled>Pilih Nama</option>
                    <?php foreach ($anggota as $key => $data): ?>
                      <option value=<?php echo $data->NIP ?>><?php echo $data->username ?></option>
                    <?php endforeach ?>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select id="inputPelaksana_Satu" class="form-control custom-select" onchange="myFunctionPel1(this.value);">
                    <option selected disabled>Pilih Nama</option>
                    <?php foreach ($anggota as $key => $data): ?>
                      <option value=<?php echo $data->NIP ?>><?php echo $data->username ?></option>
                    <?php endforeach ?>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select id="inputPelaksana_Dua" class="form-control custom-select" onchange="myFunctionPel2(this.value);">
                    <option selected disabled>Pilih Nama</option>
                    <?php foreach ($anggota as $key => $data): ?>
                      <option value=<?php echo $data->NIP ?>><?php echo $data->username ?></option>
                    <?php endforeach ?>
...
<script>
  ...
  function myFunction(element) {
    document.getElementById("NIP_Kabid").value = element;
  }

  function myFunctionSek(element) {
    document.getElementById("NIP_Seksi").value = element;
  }

  function myFunctionPel1(element) {
    document.getElementById("NIP_PenSatu").value = element;
  }

  function myFunctionPel2(element) {
    document.getElementById("NIP_PenDua").value = element;
  }
